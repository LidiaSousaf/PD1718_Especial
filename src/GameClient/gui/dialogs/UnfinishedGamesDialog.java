...
public class UnfinishedGamesDialog extends JDialog {

    private static final String[] COLUMN_TITLES = {"Jogador 1", "Jogador 2"};

    private GlobalController controller;
    private JPanel content;

    public UnfinishedGamesDialog(JFrame parent, GlobalController controller) {
        super(parent, "Histórico de jogos inacabados");
    ...
    private void setUpLayout() {
        ...
        List<GameInfo> gameList = controller.getUnfinishedGames();
    ...
    private void populateTable(List<GameInfo> gameList, GamesTableModel tableModel) {
        ...
        for (GameInfo game : gameList) {
            tableModel.addRow(new Object[]{game.getPlayer1(), game.getPlayer2()});
        }
    }
